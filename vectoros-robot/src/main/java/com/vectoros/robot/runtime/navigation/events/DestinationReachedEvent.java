...
public final class DestinationReachedEvent implements RuntimeEvent {

    private final String robotId;
    private final Coordinate destination;
    private final Instant occurredAt;

    public DestinationReachedEvent(String robotId, Coordinate destination, Instant occurredAt) {
